...
async function main() {
    ...
    await prisma.order.create({
        data: {
            ...
            status: 'delivered',
            totalAmount: 450,
            pickupTime: new Date('2026-01-28T10:00:00'),
            deliveryTime: new Date('2026-01-30T18:00:00'),
    ...
    await prisma.order.create({
        data: {
            ...
            status: 'processing',
            totalAmount: 850,
            pickupTime: new Date('2026-02-01T14:00:00'),
            deliveryTime: new Date('2026-02-03T14:00:00'),
    ...
    await prisma.order.create({
        data: {
            ...
            status: 'pending',
            totalAmount: 1200,
            pickupTime: new Date('2026-02-03T11:00:00'),
            deliveryTime: new Date('2026-02-04T20:00:00'),
    ...
    await prisma.order.create({
        data: {
            ...
            totalAmount: 600,
            pickupTime: new Date('2026-01-31T16:00:00'),
            deliveryTime: new Date('2026-02-02T16:00:00'),
            serviceType: 'Standard',
            paymentStatus: 'paid',
            hasIssue: false,
            items: {
    ...
    await prisma.order.create({
        data: {
            ...
            status: 'processing',
            totalAmount: 750,
            pickupTime: new Date('2026-01-30T12:00:00'),
            deliveryTime: new Date('2026-02-02T12:00:00'),
            serviceType: 'Standard',
            paymentStatus: 'paid',
            hasIssue: true,
            issueType: 'damage',
    ...
    await prisma.order.create({
        data: {
            ...
            status: 'cancelled',
            totalAmount: 300,
            pickupTime: new Date('2026-01-29T10:00:00'),
            deliveryTime: new Date('2026-02-01T10:00:00'),
            serviceType: 'Standard',
    ...
    await prisma.order.create({
        data: {
            ...
            totalAmount: 350,
            pickupTime: new Date('2026-02-02T09:00:00'),
            deliveryTime: new Date('2026-02-05T09:00:00'),
            serviceType: 'Standard',
            paymentStatus: 'pending',
            hasIssue: false,
            items: {
