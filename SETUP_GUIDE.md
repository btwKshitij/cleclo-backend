...
2.  **Create Databases**:
    ...
    ```
    _(Alternatively, you can use a single `cleclo_db` but having separate ones ensures true microservice isolation.)_
...
_Replace `yourpassword` with your actual Postgres password._
...
_This prevents "Module not found" or "Prisma Version Mismatch" errors._
